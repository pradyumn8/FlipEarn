        ...
        <div className='relative bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition'>
            ...
            <div className="p-5 pt-8">
                ...
                <div className='flex item-center justify-between'>
                    ...
                    <button onClick={()=> {navigator(`/listing/${listing.id}`); scrollTo(0,0)}} className='px-7 py-3 bg-indigo-600 text-white text-sm rounded-lg hover:bg-indigo-700 transition'>
                        More Details
                    </button>
                </div>
            </div>
