  ...
  return (
    <div>
            ...
            <div className="flex flex-col items-center justify-center text-center py-12 md:py-16 rounded-[15px] bg-gradient-to-r from-[#F3EAFF] to-[#E1EFFF]">  
                ...
                <p className="text-slate-500 mt-2 max-w-lg max-md:text-sm">We are the leading social media marketPlace that connects brands with their customers With our user-freindly interface.</p>
