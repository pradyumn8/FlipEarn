...
const ChatBox = () => {
    ...
    const handleSendMessage = async (e)=> {
        ...
        setMessages([...messages, {id: Date.now(), chatId:chat.id, sender_id: user.id, message: newMessage, creditedAt: new Date()}]);
        setNewMessage("")
    }
    ...
    return (
        <div className='fixed inset-0 bg-black/70 backdrop-blur bg-opacity-50 z-100 flex items-center justify-center sm:p-4'>
            <div className='bg-white sm:rounded-lg shodow-2xl w-full max-w-2xl h-screen sm:h-[600px] flex flex-col'>
                {/* Header */}
                    ...
                    (
                        <form onSubmit={handleSendMessage} className='p-4 bg-white border-t border-gray-200 rounded-b-lg'>
                            <div className='flex items-end space-x-2'>
                                ...
                                placeholder='Type your message...' className='flex-1 resize-none border border-gray-300 rounded-lg px-4 py-2 focus:outline0indigo-500 max-h-32' rows={1} />
